...
router.delete("/v1/invoices/delete/:invoiceId", tokenHandler_1.authenticateJWT, async (req, res) => {
    try {
        const token = await (0, externalAuth_1.otherAPIAuth)();
        const externalApiResponse = await axios_1.default.delete(`https://seng2021-t11a-gg.9n5c02mxxr5nc.ap-southeast-2.cs.amazonlightsail.com/invoices/${req.params.invoiceId}`, {
            headers: {
                token: token
            }
        });
