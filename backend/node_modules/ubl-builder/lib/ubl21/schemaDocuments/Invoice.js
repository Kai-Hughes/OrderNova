...
var CommonAggregateComponents_1 = require("../CommonAggregateComponents");
var extensionComponents_1 = require("../extensionComponents");
var UnqualifiedDataTypes_1 = require("../types/UnqualifiedDataTypes");
var dateFormatter_1 = require("../../tools/dateFormatter");
var builder = require("xmlbuilder");
var shas_1 = require("../../tools/shas");
var mathTools_1 = require("../../tools/mathTools");
var ChildrenMap_1 = require("./ChildrenMap");
var Invoice = /** @class */ (function () {
    ...
    function Invoice(id, options) {
        ...
        var _a = dateFormatter_1.decomposeTime(options.timestamp), year = _a.year, month = _a.month, dayOfMonth = _a.dayOfMonth, hourOfDay = _a.hourOfDay, minute = _a.minute, second = _a.second;
        // DEFAULT VALUES
        this.setID(id);
    ...
    Invoice.prototype.addProperty = function (key, value) {
        this.xmlRef.Invoice["@" + key] = value;
        return this;
    };
    Invoice.prototype.removeProperty = function (key, value) {
        this.xmlRef.Invoice["@" + key] = value;
        return this;
    };
    Invoice.prototype.setDefaultProperties = function () {
        var _this = this;
        ...
        defaultProperties.forEach(function (item) { return _this.addProperty(item.key, item.value); });
    };
    /**
     * An identifier for the Extension assigned by the creator of the extension.
     * @param value
     */
    Invoice.prototype.setUBLExtensions = function (value) {
     ...
     * @param attributes
     */
    Invoice.prototype.setUBLVersionID = function (value, attributes) {
     ...
     * @param attributes
     */
    Invoice.prototype.setCustomizationID = function (value, attributes) {
     ...
     */
    Invoice.prototype.setProfileID = function (value, attributes) {
        this.validateInstanceOf(value, ['string', UnqualifiedDataTypes_1.UdtIdentifier]);
     ...
     * @param attributes attributes
     */
    Invoice.prototype.setProfileExecutionID = function (value, attributes) {
        this.validateInstanceOf(value, ['string', UnqualifiedDataTypes_1.UdtIdentifier]);
     ...
     */
    Invoice.prototype.setID = function (value, attributes) {
     ...
     */
    Invoice.prototype.getID = function (raw) {
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.setCopyIndicator = function (value) {
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.setUUID = function (value, attributes) {
        this.validateInstanceOf(value, ['string', UnqualifiedDataTypes_1.UdtIdentifier]);
     ...
     * @param value
     */
    Invoice.prototype.setIssueDate = function (value) {
     ...
     * @param value
     */
    Invoice.prototype.setIssueTime = function (value) {
        this.validateInstanceOf(value, ['string']);
     ...
     * @param value
     */
    Invoice.prototype.setDueDate = function (value) {
        this.validateInstanceOf(value, ['string']);
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.setInvoiceTypeCode = function (value, attributes) {
        this.validateInstanceOf(value, ['string']);
     ...
     * @param attributes
     */
    Invoice.prototype.addNote = function (value, attributes) {
        if (value === null) {
     ...
     * @param value
     */
    Invoice.prototype.setTaxPointDate = function (value) {
     ...
     * @param attributes
     */
    Invoice.prototype.setDocumentCurrencyCode = function (value, attributes) {
        // if (value === null) {
     ...
     * @param attributes
     */
    Invoice.prototype.setTaxCurrencyCode = function (value, attributes) {
        // if (value === null) {
     ...
     * @param attributes
     */
    Invoice.prototype.setPricingCurrencyCode = function (value, attributes) {
        // if (value === null) {
     ...
     * @param attributes
     */
    Invoice.prototype.setPaymentCurrencyCode = function (value, attributes) {
        // if (value === null) {
     ...
     * @param attributes
     */
    Invoice.prototype.setPaymentAlternativeCurrencyCode = function (value, attributes) {
        // if (value === null) {
     ...
     * @param attributes
     */
    Invoice.prototype.setAccountingCostCode = function (value, attributes) {
        // if (value === null) {
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.setAccountingCost = function (value, attributes) {
     ...
     * @param attributes
     */
    Invoice.prototype.setLineCountNumeric = function (value, attributes) {
     ...
     * @param attributes
     */
    Invoice.prototype.setBuyerReference = function (value, attributes) {
        // if (value === null) {
     ...
     * @param value
     */
    Invoice.prototype.addInvoicePeriod = function (value) {
        if (!this.children.invoicePeriods)
            this.children.invoicePeriods = [];
        var itemToPush = value instanceof CommonAggregateComponents_1.PeriodType ? value : new CommonAggregateComponents_1.PeriodType(value);
        this.children.invoicePeriods.push(itemToPush);
        return this;
    };
    Invoice.prototype.clearInvoicePeriods = function () {
     ...
     * @param value
     */
    Invoice.prototype.setOrderReference = function (value) {
        // if (input === null) {
     ...
     * @param value
     */
    Invoice.prototype.addBillingReference = function (value) {
        if (!this.children.billingReferences) {
            this.children.billingReferences = [];
        }
        var itemToPush = value instanceof CommonAggregateComponents_1.BillingReference ? value : new CommonAggregateComponents_1.BillingReference(value);
     ...
     * @param input
     */
    Invoice.prototype.addDespatchDocumentReference = function (input) {
        if (!this.children.despatchDocumentReferences) {
            this.children.despatchDocumentReferences = [];
        }
        var itemToPush = input instanceof CommonAggregateComponents_1.DespatchDocumentReference ? input : new CommonAggregateComponents_1.DespatchDocumentReference(input);
     ...
     * @param input
     */
    Invoice.prototype.addReceiptDocumentReference = function (input) {
        if (!this.children.receiptDocumentReferences) {
            this.children.receiptDocumentReferences = [];
        }
        var itemToPush = input instanceof CommonAggregateComponents_1.ReceiptDocumentReference ? input : new CommonAggregateComponents_1.ReceiptDocumentReference(input);
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.addStatementDocumentReference = function (input) {
        if (!this.children.statementDocumentReferences) {
            this.children.statementDocumentReferences = [];
        }
        var itemToPush = input instanceof CommonAggregateComponents_1.StatementDocumentReference ? input : new CommonAggregateComponents_1.StatementDocumentReference(input);
     ...
     * @param input
     */
    Invoice.prototype.addOriginatorDocumentReference = function (input) {
        if (!this.children.originatorDocumentReferences) {
            this.children.originatorDocumentReferences = [];
        }
        var itemToPush = input instanceof CommonAggregateComponents_1.OriginatorDocumentReference ? input : new CommonAggregateComponents_1.OriginatorDocumentReference(input);
     ...
     * @param input
     */
    Invoice.prototype.addContractDocumentReference = function (input) {
        if (!this.children.contractDocumentReferences) {
            this.children.contractDocumentReferences = [];
        }
        var itemToPush = input instanceof CommonAggregateComponents_1.ContractDocumentReference ? input : new CommonAggregateComponents_1.ContractDocumentReference(input);
     ...
     * @param input
     */
    Invoice.prototype.addAdditionalDocumentReference = function (input) {
        if (!this.children.additionalDocumentReferences) {
            this.children.additionalDocumentReferences = [];
        }
        var itemToPush = input instanceof CommonAggregateComponents_1.AdditionalDocumentReference ? input : new CommonAggregateComponents_1.AdditionalDocumentReference(input);
     ...
     * @param input
     */
    Invoice.prototype.addProjectReference = function (input) {
        if (!this.children.projectReferences) {
            this.children.projectReferences = [];
        }
        var itemToPush = input instanceof CommonAggregateComponents_1.ProjectReference ? input : new CommonAggregateComponents_1.ProjectReference(input);
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.addSignature = function (value) {
        if (!this.children.signatures) {
            this.children.signatures = [];
        }
        var itemToPush = value instanceof CommonAggregateComponents_1.Signature ? value : new CommonAggregateComponents_1.Signature(value);
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.setAccountingSupplierParty = function (value) {
        // if (input === null) {
     ...
     * @param input
     */
    Invoice.prototype.setAccountingCustomerParty = function (value) {
        this.children.accountingCustomerParty =
            value instanceof CommonAggregateComponents_1.AccountingCustomerParty ? value : new CommonAggregateComponents_1.AccountingSupplierParty(value);
        return this;
    };
    /**
     * 37.  The payee.
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.setPayeeParty = function (input) {
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.setBuyerCustomerParty = function (input) {
        throw new Error('not implemented');
    };
    /**
     * 39.  The seller
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.setSellerSupplierParty = function (input) {
        throw new Error('not implemented');
    };
    /**
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.setTaxRepresentativeParty = function (input) {
     ...
     * @param value
     */
    Invoice.prototype.addDelivery = function (value) {
        if (!this.children.deliveries) {
            this.children.deliveries = [];
        }
        var itemToPush = value instanceof CommonAggregateComponents_1.Delivery ? value : new CommonAggregateComponents_1.Delivery(value);
     ...
     * @param value
     */
    Invoice.prototype.setDeliveryTerms = function (value) {
     ...
     * @param value
     */
    Invoice.prototype.addPaymentMeans = function (value) {
        if (!this.children.paymentMeans) {
            this.children.paymentMeans = [];
        }
        var itemToPush = value instanceof CommonAggregateComponents_1.PaymentMeans ? value : new CommonAggregateComponents_1.PaymentMeans(value);
     ...
     * @param value
     */
    Invoice.prototype.addPaymentTerm = function (value) {
        throw new Error('not implemented');
    };
    /**
     ...
     * @param value
     */
    Invoice.prototype.addPrepaidPayment = function (value) {
        if (!this.children.prepaidPayments) {
            this.children.prepaidPayments = [];
        }
        var itemToPush = value instanceof CommonAggregateComponents_1.PrepaidPayment ? value : new CommonAggregateComponents_1.PrepaidPayment(value);
     ...
     * @param value
     */
    Invoice.prototype.addAllowanceCharge = function (value) {
        throw new Error('not implemented');
    };
    /**
     ...
     * @param value
     */
    Invoice.prototype.setTaxExchangeRate = function (value) {
        throw new Error('not implemented');
    };
    /**
     ...
     * @param value
     */
    Invoice.prototype.setPricingExchangeRate = function (value) {
        throw new Error('not implemented');
    };
    /**
     ...
     * @param {  } value
     */
    Invoice.prototype.setPaymentExchangeRate = function (value) {
     ...
     * @param { any } value
     */
    Invoice.prototype.setPaymentAlternativeExchangeRate = function (value) {
        throw new Error('not implemented');
    };
    /**
     ...
     * @param value
     */
    Invoice.prototype.addTaxTotal = function (value) {
        if (!this.children.taxTotals) {
            this.children.taxTotals = [];
        }
        var itemToPush = value instanceof CommonAggregateComponents_1.TaxTotal ? value : new CommonAggregateComponents_1.TaxTotal(value);
     ...
     * @param { any } value
     */
    Invoice.prototype.addWithholdingTaxTotal = function (value) {
        throw new Error('not implemented');
    };
    /**
     ...
     * @param value
     */
    Invoice.prototype.setLegalMonetaryTotal = function (value) {
     ...
     * @param value
     */
    Invoice.prototype.addInvoiceLine = function (value) {
        if (!this.children.invoiceLines) {
            this.children.invoiceLines = [];
        }
        var invoiceLine = value instanceof CommonAggregateComponents_1.InvoiceLine ? value : new CommonAggregateComponents_1.InvoiceLine(value);
     ...
     * @param asString
     */
    Invoice.prototype.findTaxTotalById = function (taxId, asString) {
        if (asString === void 0) { asString = true; }
        var taxTotal = (this.children.taxTotals || []).find(function (tt) { return tt.getTaxSubtotals()[0].getTaxCategory().getTaxScheme().getId() === taxId; });
        var taxAmount = taxTotal ? mathTools_1.fixDecimals(taxTotal.getTaxAmount()) : '0.00';
     ...
     * @returns {Invoice}
     */
    Invoice.prototype.applyCufeCode = function () {
        var paramsToEncode = '';
        var ivaTaxAmount = this.findTaxTotalById('01'); // Iva Tax
        var incTaxAmount = this.findTaxTotalById('04'); // INC Tax
        var icaTaxAmount = this.findTaxTotalById('03'); // ICA Tax
        var codeToHash = this.children.invoiceTypeCode.content === '03'
        ...
        var mapToHash = [
            ...
            */
            ...
            /* Valor impuesto 03 - ICA, con punto decimal, con decimales a dos (2) dígitos, sin separadores
              ...
              representa con 0.00 */
            { name: 'ValImp3', value: icaTaxAmount },
            ...
            */
            { name: 'TipoAmbiente', value: this.options.enviroment },
        ];
        paramsToEncode = mapToHash.map(function (item) { return item.value; }).join('');
        // console.log("Composicion del CUFE => ", paramsToEncode);
        var CUFE = new shas_1.SHA384().getHash(paramsToEncode, 'binary', 'hex');
        this.setUUID(CUFE, { schemeName: 'CUFE-SHA384', schemeID: this.options.enviroment });
    };
    Invoice.prototype.applyQRCode = function () {
        var CUFE = this.children.uuid.content;
        var stringToHash = "https://catalogovpfe.dian.gov.co/document/searchqr?documentkey=" + CUFE;
        var QRCode = new shas_1.SHA384().getHash(stringToHash, 'binary', 'hex');
    ...
    Invoice.prototype.calculateDianExtension = function () {
        var softwareProvider = this.options.software;
        var issuer = this.options.issuer;
        var softwareSecurityCodeHashed = new shas_1.SHA384().getHash(softwareProvider.id + softwareProvider.pin + this.children.id.content, 'binary', 'hex');
        var extensionsNode = new extensionComponents_1.UBLExtensions();
    ...
    Invoice.prototype.getQRCode = function () {
     ...
     */
    Invoice.prototype.validateInstanceOf = function (value, classRefs) {
        // if(!value){
        //   this.children[attribute] = null
        // }
        var matchList = classRefs.filter(function (classRef) {
        ...
        if (matchList.length === 0) {
            var classNames = classRefs.map(function (cr) { return cr.name || cr; });
     ...
     */
    Invoice.prototype.getXml = function (pretty, headless) {
        var _this = this;
        if (pretty === void 0) { pretty = false; }
        if (headless === void 0) { headless = false; }
        Object.keys(ChildrenMap_1.INVOICE_CHILDREN_MAP)
            .filter(function (attKey) { return _this.children[attKey]; })
            .forEach(function (attKey) {
            var _a = ChildrenMap_1.INVOICE_CHILDREN_MAP[attKey], childName = _a.childName, max = _a.max;
            var isChildAnArray = Array.isArray(_this.children[attKey]);
            // validate array condition
            if (max && max > 1 && !isChildAnArray) {
                throw new Error(attKey + " must to be an Array");
            }
            _this.xmlRef.Invoice[childName] = isChildAnArray
                ? _this.children[attKey].map(function (e) { return e.parseToJson(); })
                : _this.children[attKey].parseToJson();
        });
        return builder.create(this.xmlRef, { encoding: 'UTF-8', standalone: false, headless: headless }).end({ pretty: pretty });
    };
    return Invoice;
}());
