import { InvoiceLine, InvoiceLineParams, TaxTotal, TaxTotalTypeParams, LegalMonetaryTotal, MonetaryTotalParams, PrepaidPayment, PaymentTypeParams, PaymentExchangeRate, ExchangeRateParams, DeliveryTerms, DeliveryTermsParams, PaymentMeans, PaymentMeansParams, Delivery, DeliveryTypeParams, TaxRepresentativeParty, PartyParams, AccountingCustomerParty, AccountingSupplierParty, SupplierPartyTypeParams, Signature, SignatureParams, ProjectReference, ProjectReferenceParams, AdditionalDocumentReference, AdditionalDocumentReferenceParams, ContractDocumentReference, ContractDocumentReferenceParams, OriginatorDocumentReference, OriginatorDocumentReferenceParams, StatementDocumentReference, StatementDocumentReferenceParams, ReceiptDocumentReference, ReceiptDocumentReferenceParams, DespatchDocumentReference, DespatchDocumentReferenceParams, BillingReference, BillingReferenceParams, PeriodTypeParams, PeriodType, OrderReference, OrderReferenceParams } from '../CommonAggregateComponents';
...
export default class Invoice {
     ...
     * @param value
     */
    addAllowanceCharge(value: any): void;
    /**
     * 47 A discount or charge that applies to a price component..
     * @param value
     */
    setTaxExchangeRate(value: any): void;
    /**
