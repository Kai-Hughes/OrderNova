...
var XsdAnySimpleType_1 = require("./XsdAnySimpleType");
/**
 ...
 *
 */
var XsdBase64Binary = /** @class */ (function (_super) {
    __extends(XsdBase64Binary, _super);
    function XsdBase64Binary(content, attributtes) {
        var _this = _super.call(this, content, attributtes) || this;
        _this.validateContent();
        return _this;
    }
    return XsdBase64Binary;
}(XsdAnySimpleType_1.default));
exports.default = XsdBase64Binary;
