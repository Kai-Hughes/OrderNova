 ...
 *
 */
var CreditNoteLineType = /** @class */ (function (_super) {
    __extends(CreditNoteLineType, _super);
    /**     *
     * @param {AllowedParams} content
     * @param {string} name
     */
    function CreditNoteLineType(content) {
        return _super.call(this, content, ParamsMap, 'cac:CreditNoteLineType') || this;
    }
    /**
     * @returns {TaxTotal}
     */
    CreditNoteLineType.prototype.getTaxTotals = function () {
        return this.attributes.taxTotals;
    };
    CreditNoteLineType.prototype.setId = function (value) {
