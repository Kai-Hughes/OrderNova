 ...
 *
 */
var MonetaryTotal = /** @class */ (function (_super) {
    __extends(MonetaryTotal, _super);
    /**     *
     * @param {AllowedParams} content
     * @param {string} name
     */
    function MonetaryTotal(content) {
        return _super.call(this, content, ParamsMap, 'cac:MonetaryTotal') || this;
    }
    /**
     *
     * @param {boolean} raw Raw value
     */
    MonetaryTotal.prototype.getLineExtensionAmount = function (raw) {
     ...
     */
    MonetaryTotal.prototype.getPayableAmount = function (raw) {
        if (raw === void 0) { raw = true; }
