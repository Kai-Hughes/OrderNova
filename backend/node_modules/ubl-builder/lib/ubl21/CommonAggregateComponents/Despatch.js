...
var ContactTypeGroup_1 = require("./ContactTypeGroup");
 ...
 */
var Despatch = /** @class */ (function (_super) {
    __extends(Despatch, _super);
    function Despatch(content) {
        return _super.call(this, content, ParamsMap, 'cac:Despatch') || this;
    }
    return Despatch;
