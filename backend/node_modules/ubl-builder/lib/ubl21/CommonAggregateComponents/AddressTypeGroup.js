...
exports.DespatchAddress = exports.DeliveryAddress = exports.JurisdictionRegionAddress = exports.RegistrationAddress = exports.AddressParams = exports.Address = void 0;
...
var AddressLine_1 = require("./AddressLine");
var CountryTypeGroup_1 = require("./CountryTypeGroup");
var ParamsMap = {
    ...
    cityName: { order: 18, attributeName: 'cbc:CityName', min: 0, max: 1, classRef: UnqualifiedDataTypes_1.UdtName },
    ...
    countrySubentity: { order: 20, attributeName: 'cbc:CountrySubentity', min: 0, max: 1, classRef: UnqualifiedDataTypes_1.UdtText },
    ...
    countrySubentityCode: { order: 21, attributeName: 'cbc:CountrySubentityCode', min: 0, max: 1, classRef: UnqualifiedDataTypes_1.UdtCode },
    ...
    addressLines: { order: 25, attributeName: 'cac:AddressLine', min: 0, max: undefined, classRef: AddressLine_1.AddressLine },
    /** 26  cac:Country [0..1]    The country in which this address is situated. */
    country: { order: 26, attributeName: 'cac:Country', min: 0, max: 1, classRef: CountryTypeGroup_1.Country },
};
/**
 * cac:AddressType
...
var Address = /** @class */ (function (_super) {
    ...
    function Address(content) {
        return _super.call(this, content, ParamsMap, 'cac:AddressType') || this;
    }
    Address.prototype.addAddressLine = function (value) {
        if (!this.attributes.addressLines) {
            this.attributes.addressLines = [];
        }
        var itemToPush = value instanceof AddressLine_1.AddressLine ? value : new AddressLine_1.AddressLine({ line: value });
        this.attributes.addressLines.push(itemToPush);
    };
    Address.prototype.setCountry = function (value) {
        if (value instanceof CountryTypeGroup_1.Country) {
            this.attributes.country = value;
        }
        else if (typeof value === 'string') {
            this.attributes.country = new CountryTypeGroup_1.Country({ name: value });
        }
        else {
            this.attributes.country = new CountryTypeGroup_1.Country(value);
        }
    };
    /**
     *
     ...
     * @param attributes
     */
    Address.prototype.setId = function (value, attributes) {
        this.attributes.id = value instanceof UnqualifiedDataTypes_1.UdtIdentifier ? value : new UnqualifiedDataTypes_1.UdtIdentifier(value, attributes);
    };
    return Address;
}(GenericAggregateComponent_1.default));
exports.Address = Address;
exports.AddressParams = Address;
exports.RegistrationAddress = Address;
exports.JurisdictionRegionAddress = Address;
exports.DeliveryAddress = Address;
exports.DespatchAddress = Address;
