 ...
 *
 */
var ShipmentType = /** @class */ (function (_super) {
    __extends(ShipmentType, _super);
    function ShipmentType(content) {
        return _super.call(this, content, ParamsMap, 'cac:ShipmentType') || this;
    }
    return ShipmentType;
