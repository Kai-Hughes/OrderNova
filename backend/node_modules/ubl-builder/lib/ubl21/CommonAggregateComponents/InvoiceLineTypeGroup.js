...
var PeriodTypeGroup_1 = require("./PeriodTypeGroup");
var OrderLineReference_1 = require("./OrderLineReference");
var LineReferenceTypeGroup_1 = require("./LineReferenceTypeGroup");
var BillingReference_1 = require("./BillingReference");
var DocumentReferenceGroup_1 = require("./DocumentReferenceGroup");
var PartyTypeGroup_1 = require("./PartyTypeGroup");
var DeliveryTypeGroup_1 = require("./DeliveryTypeGroup");
var PaymentTermsTypeGroup_1 = require("./PaymentTermsTypeGroup");
var TaxTotalTypeGroup_1 = require("./TaxTotalTypeGroup");
var ItemTypeGroup_1 = require("./ItemTypeGroup");
var PriceTypeGroup_1 = require("./PriceTypeGroup");
var DeliveryTerms_1 = require("./DeliveryTerms");
/*
...
var InvoiceLine = /** @class */ (function (_super) {
    ...
    function InvoiceLine(content) {
        return _super.call(this, content, ParamsMap, 'cac:InvoiceLine') || this;
    }
    /**
     * @returns { TaxTotal[] }
     */
    InvoiceLine.prototype.getTaxTotals = function () {
        return this.attributes.taxTotals;
    };
    /**
     * @param { TaxTotal[] } taxTotals
     */
    InvoiceLine.prototype.setTaxTotals = function (taxTotals) {
        if (!Array.isArray(taxTotals))
            throw new Error('value must to be an Array');
        taxTotals.forEach(function (value) {
    ...
    InvoiceLine.prototype.setId = function (value) {
     ...
     */
    InvoiceLine.prototype.getLineExtensionAmount = function (rawValue) {
    ...
    InvoiceLine.prototype.setLineExtensionAmount = function (value, currencyID) {
        if (currencyID === void 0) { currencyID = 'COP'; }
        if (!value)
            throw new Error('value is required');
        this.attributes.lineExtensionAmount = value instanceof UdtAmount_1.UdtAmount ? value : new UdtAmount_1.UdtAmount(value, { currencyID: currencyID });
    };
    /**
     * @returns { Price } Price object
     */
    InvoiceLine.prototype.getPrice = function () {
